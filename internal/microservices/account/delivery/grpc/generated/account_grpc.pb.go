...
type AccountServiceClient interface {
	...
	Update(ctx context.Context, in *UpdasteRequest, opts ...grpc.CallOption) (*UpdateResponse, error)
...
func (c *accountServiceClient) Update(ctx context.Context, in *UpdasteRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
...
type AccountServiceServer interface {
	...
	Update(context.Context, *UpdasteRequest) (*UpdateResponse, error)
...
func (UnimplementedAccountServiceServer) Update(context.Context, *UpdasteRequest) (*UpdateResponse, error) {

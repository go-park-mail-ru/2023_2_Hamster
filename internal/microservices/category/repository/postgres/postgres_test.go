...
// 		{
// 			name:      "Success",
// 			tag:       models.Category{UserID: uuid.New(), ParentID: uuid.Nil, Image: 1, Name: "TestTag", ShowIncome: true, ShowOutcome: true, Regular: true},
// 			returnID:  testUUID,
// 			expected:  testUUID,
// 			returnErr: nil,
// 			err:       nil,
...
// 				WithArgs(tc.tag.UserID, tc.tag.ParentID, tc.tag.Image, tc.tag.Name, tc.tag.ShowIncome, tc.tag.ShowOutcome, tc.tag.Regular).
